            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class=" navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0  ">
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2" aria-current="page" href="inicioV.frm.php"><i class="fas fa-home"></i> Inicio</a>
                    </li>
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2 " href="documentoV.frm.php"><i class="fas fa-file"></i> Documentos</a>
                    </li>
                </ul>
            </div>
            <form class="d-flex">
